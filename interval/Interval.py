class Interval:
	...
	def __contains__(self, item):
		if item.__class__.__name__ == "interval":
			return self > item
			...
			raise TypeError("item must be interval or Intervals. (got ", item.__class__.__name__, " class)")
...
class Intervals:
	...
	def check_interval(interval):
		if isinstance(interval, Interval):
			...
			raise TypeError(
				"the arguments's element must be list or interval.(we recommend interval because list is change to interval.)")
		return interval
